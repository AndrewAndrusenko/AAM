-- FUNCTION: public.f_orders_allocation(numeric, numeric[])

-- DROP FUNCTION IF EXISTS public.f_orders_allocation(numeric, numeric[]);

CREATE OR REPLACE FUNCTION public.f_alloc_get_allocation_info(
	trade_qty numeric,
...
ALTER FUNCTION public.f_orders_allocation(numeric, numeric[])
    OWNER TO postgres;
