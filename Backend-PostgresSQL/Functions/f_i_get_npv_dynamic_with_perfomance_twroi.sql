...
DROP FUNCTION IF EXISTS public.f_i_get_npv_dynamic_with_perfomance_twroi(text[], date,date,numeric);

CREATE OR REPLACE FUNCTION public.f_i_get_npv_dynamic_with_perfomance_twroi(
...
ALTER FUNCTION public.f_i_get_npv_dynamic_with_perfomance_twroi (text[], date,date,numeric)
    OWNER TO postgres;
select rates_set.cross_rate,
f_i_get_npv_dynamic_with_perfomance_twroi.*
-- from f_i_get_npv_dynamic_with_perfomance_twroi( Array['ACM002'],'10/20/2023','11/28/2023',840)
from f_i_get_npv_dynamic_with_perfomance_twroi(array(select portfolioname from dportfolios),'05/01/2023','12/04/2023',810)
...
left join lateral (
	...
	where 
	f_i_get_cross_ratesfor_period_currencylist.rate_date<=f_i_get_npv_dynamic_with_perfomance_twroi.report_date
