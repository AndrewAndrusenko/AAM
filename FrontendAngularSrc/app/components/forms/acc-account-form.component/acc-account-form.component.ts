...
import { bAccounts, bLedger, bcAccountType_Ext, bcEnityType } from 'FrontendAngularSrc/app/models/accountng-intefaces.model';
...
import { ClientData, currencyCode } from 'FrontendAngularSrc/app/models/interfaces.model';
