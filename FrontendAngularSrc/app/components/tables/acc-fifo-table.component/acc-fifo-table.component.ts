...
import {FifoTableData } from 'FrontendAngularSrc/app/models/accountng-intefaces.model';
import {AccountingTradesService } from 'FrontendAngularSrc/app/services/accounting-trades.service';
