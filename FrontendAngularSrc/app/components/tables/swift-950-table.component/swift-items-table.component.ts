...
import {bcTransactionType_Ext, SWIFTSGlobalListmodel, SWIFTStatement950model } from 'FrontendAngularSrc/app/models/accountng-intefaces.model';
...
import {bcEntryParameters} from 'FrontendAngularSrc/app/models/acc-schemes-interfaces';
@Component({
