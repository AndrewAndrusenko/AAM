...
import { counterParty, trades } from 'FrontendAngularSrc/app/models/interfaces.model';
...
import { Instruments } from 'FrontendAngularSrc/app/models/instruments.interfaces';
@Component({
