...
FROM f_getOpeingBalancebyLedgerId ('2023-02-22',2) AS "IncomingBalances"
left join LATERAL "bcAccountType_Ext" on "bcAccountType_Ext"."accountType_Ext" = "bLedger"."accountTypeID"
