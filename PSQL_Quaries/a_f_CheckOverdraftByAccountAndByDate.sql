-- FUNCTION: public.f_checkoverdraftbyaccountandbydate(date, numeric, numeric, numeric, numeric)

-- DROP FUNCTION IF EXISTS public.f_checkoverdraftbyaccountandbydate(date, numeric, numeric, numeric, numeric);
...
ALTER FUNCTION public.f_checkoverdraftbyaccountandbydate(date, numeric, numeric, numeric, numeric)
    OWNER TO postgres;
