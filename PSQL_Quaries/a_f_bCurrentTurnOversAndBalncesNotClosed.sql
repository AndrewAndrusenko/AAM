CREATE OR REPLACE FUNCTION public.bCurrentTurnOversAndBalncesNotClosed(lastClosedBalanceDate date)
    RETURNS TABLE
	( "accountId" numeric, "accountNo" text, "dataTime" date, "xActTypeCode" numeric, "openingBalance" numeric, "corrOpeningBalance" numeric, "signedTurnOver" numeric, "totalCredit" numeric, "totalDebit" numeric) 
    LANGUAGE 'sql'
    COST 100
...
ALTER FUNCTION public.bCurrentTurnOversAndBalncesNotClosed(lastClosedBalanceDate date)
    OWNER TO postgres;
