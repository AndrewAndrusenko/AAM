...
SELECT "bAccountTransaction"."accountId",
  ...
  SUM(
	...
	END) 
	AS "closingBalance",
    COALESCE(sum("bAccountTransaction"."amountTransaction") FILTER (WHERE "bAccountTransaction"."XactTypeCode" = 1)::real, 0) 
	AS "totalCredit",
    COALESCE(sum("bAccountTransaction"."amountTransaction") FILTER (WHERE "bAccountTransaction"."XactTypeCode" = 2)::real, 0) 
	AS "totalDebit"
...
GROUP BY "bAccountTransaction"."accountId", "bAccounts"."accountNo",date_trunc('day',"dataTime"), "IncomingBalances"."closingBalance", "bcAccountType_Ext"."xActTypeCode"
