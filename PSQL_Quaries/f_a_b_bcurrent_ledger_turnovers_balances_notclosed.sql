...
-- DROP FUNCTION IF EXISTS public.f_a_b_bcurrent_ledger_turnovers_balances_notclosed(date);

CREATE OR REPLACE FUNCTION public.f_a_b_bcurrent_ledger_turnovers_balances_notclosed(
...
ALTER FUNCTION public.f_a_b_bcurrent_ledger_turnovers_balances_notclosed(date)
    OWNER TO postgres;
