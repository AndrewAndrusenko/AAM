-- FUNCTION: public.f_i_o_create_orders_by_mp_v2(integer, text[], text[], date, integer, numeric)

-- DROP FUNCTION IF EXISTS public.f_i_o_create_orders_by_mp_v2(integer, text[], text[], date, integer, numeric);
...
ALTER FUNCTION public.f_i_o_create_orders_by_mp_v2(integer, text[], text[], date, integer, numeric)
    OWNER TO postgres;
