...
@Component({
  selector: 'app-table-mp-structure',
  templateUrl: './app-table-mp-structure.component.html',
  styleUrls: ['./app-table-mp-structure.component.scss'],
  animations: [
...
export class AppTableMPStructure implements AfterViewInit {
